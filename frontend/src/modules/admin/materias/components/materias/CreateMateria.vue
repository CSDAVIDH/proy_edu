...
import { storeMateria } from '@/api/materias/materiasApi';
  ...
  return console.log(form.value)
    ...
    if (validate.value) {
        Swal.fire({
            ...
            preConfirm: () => {
                loading.value = true;
                createMateria.mutate(form.value);
            },
        });
    } else {
...
<template>
    <ModalMd :isModal="isModal" @close="closeModal" :title="'Crear Nueva Materia'">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="MATEMATICAS" id="nombre" :value="form.nombre" name="nombre"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" placeholder="100" id="horas_cademicas" :value="form.horas_cademicas"
                            name="horas_cademicas" @change="handleChange" @blur="handleBlur" class="form-control"
                            required />
