...
import { storeDocente } from "@/api/usuarios/docenteApi";
...
<template>
    <ModalMd :isModal="isModal" @close="closeModal" :title="'Registrar nuevo Docente'">
